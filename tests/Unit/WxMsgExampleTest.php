...
use Douyuxingchen\PhpWorkWechat\Crypto\WXBizMsgCrypt;
use PHPUnit\Framework\TestCase;

class WxMsgExampleTest extends TestCase
{
    // 参考文档
    // https://developer.work.weixin.qq.com/document/path/90238#%E8%AE%BE%E7%BD%AE%E6%8E%A5%E6%94%B6%E6%B6%88%E6%81%AF%E7%9A%84%E5%8F%82%E6%95%B0
    ...
    {
        parent::__construct();
        $this->encodingAesKey = lib_env('WORK_WECHAT_ENCODING_AES_KEY');
        $this->token = lib_env('WORK_WECHAT_TOKEN');
        $this->corpId = lib_env('WORK_WECHAT_CORP_ID');
    }
